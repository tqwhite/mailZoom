...
var moduleFunction = function(args) {
	...
	var wrapCallback = function(callback, extraFunction) {
		return function(err, result) {
			if (typeof (extraFunction) == 'function') {
				extraFunction(err, result);
			}

			if (extraFunction === true) {
	...
	self.createList = function(list, callback) {
		...
		newItem.save(wrapCallback(callback, false));
	}
	...
	self.getList = function(title, expectedFormat, callback) {
		...
		switch (expectedFormat) {
			...
			case 'fat':
				...
				break;
			default:
				callback('', new Error("expectedFormat must be either 'lean' (plain javascript object) or 'fat' (mongoose object)"));
				break;
		}
