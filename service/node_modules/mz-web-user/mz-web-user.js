...
var moduleFunction = function(args) {
	...
	authenticate = new authenticate({
		...
		mzPassportSecret: self.mzPassportSecret
	});
	...
	staticPageDispatch = new staticPageDispatch({
		router: router,
		filePathList: [self.staticPagesDirectoryPath],
		//'default':'a_main.html',
		systemParameters: {
			mzBaseUrl: this.mzBaseUrl,
			status: status
		}
	});
	...
	this.startWebListener = function() {

		app.listen(this.mzPort);

		qtools.message('Magic happens on port ' + this.mzPort + ' ');
	}
	return this;
};
